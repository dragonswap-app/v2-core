...
export function createPoolFunctions({
  ...
  swapTarget: TestDragonswapV2Callee
  token0: TestERC20
  token1: TestERC20
  pool: MockTimeDragonswapV2Pool
}): PoolFunctions {
...
export function createMultiPoolFunctions({
  ...
  swapTarget: TestDragonswapV2Router
  poolInput: MockTimeDragonswapV2Pool
  poolOutput: MockTimeDragonswapV2Pool
}): MultiPoolFunctions {
