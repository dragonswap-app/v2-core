...
describe('DragonswapV2Factory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as DragonswapV2Factory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('DragonswapV2Pool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('DragonswapV2Pool')
