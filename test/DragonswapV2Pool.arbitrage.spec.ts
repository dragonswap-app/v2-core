...
import { DragonswapV2PoolSwapTest } from '../typechain/DragonswapV2PoolSwapTest'
...
describe('DragonswapV2Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('DragonswapV2PoolSwapTest')
            const tester = (await testerFactory.deploy()) as DragonswapV2PoolSwapTest
          ...
          let tester: DragonswapV2PoolSwapTest
